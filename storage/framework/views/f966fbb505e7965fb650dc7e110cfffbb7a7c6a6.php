                            ...
                            <form method="post" action="<?php echo e(route ('loanform')); ?>" id="amt">
                              ...
                              <div class="pt-3">
                                ...
                                <div class="pt-3">
                                  ...
                                  <input id="amountloaned" type="number" class="form-control" name="amountloaned" aria-describedby="amount" required >
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OT3\resources\views/user/loanform.blade.php ENDPATH**/ ?>