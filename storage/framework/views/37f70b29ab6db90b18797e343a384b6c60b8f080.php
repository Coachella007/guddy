                        ...
                        <div class="tab-pane fade" id="pills-loan" role="tabpanel" aria-labelledby="pills-loan-tab">
							<div class="table-responsive">
								<table id="UserTable" class="UserTable table table-hover text-<?php echo e($text); ?>">
									...
									<tbody>
										<?php $__currentLoopData = $amountborrowed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr>
												<td><?php echo e($settings->currency); ?><?php echo e($amt->amountloaned); ?></td>
												<td><?php echo e($settings->currency); ?><?php echo e($amt->intrest); ?></td>
												<td><?php echo e($settings->currency); ?><?php echo e($amt->intrest + $amt->amountloaned); ?></td>
												<td>
													<?php if($amt->status == 'Processed'): ?>
														<span class="badge badge-success"><?php echo e($amt->status); ?></span>
													<?php else: ?>
														<span class="badge badge-danger"><?php echo e($amt->status); ?></span>
													<?php endif; ?>
												</td>
												<td><?php echo e(\Carbon\Carbon::parse($amt->created_at)->toDayDateTimeString()); ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\XAMPP-MYSQL\htdocs\REEL\resources\views/user/transactions.blade.php ENDPATH**/ ?>