        ...
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <?php if(Auth('admin')->User()->type == 'Super Admin' || Auth('admin')->User()->type == 'Admin'): ?>
                    ...
                    <li
                        class="nav-item <?php echo e(request()->routeIs('adminloan') ? 'active' : ''); ?>   <?php echo e(request()->routeIs('processloan') ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('/admin/dashboard/adminloan')); ?>">
                            <i class="fa fa-arrow-alt-circle-up" aria-hidden="true"></i>
                            <p>Manage Loan</p>
                        </a>
                    </li>
...
<!-- End Sidebar -->
<?php /**PATH C:\OT@2nd\resources\views/admin/sidebar.blade.php ENDPATH**/ ?>