    ...
    <?php if($loan->amountloaned > 0): ?>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="mb-3 col-md-6 mb-md-0">
                <h5 class="mb-0 text-white h3 font-weight-400">Fund your account balance / Pay Loan</h5>
            </div>
        </div>
    </div>
    <?php else: ?>
                                ...
                                <div class="row">
                                    <div class="mb-4 col-md-12">
                                        ...
                                        <input class="form-control " placeholder="Enter Amount"
                                            type="number" name="amount"  value="<?php echo e($loan->amountloaned + $loan->intrest); ?>"
                                            min="<?php echo e($loan->amountloaned + $loan->intrest); ?>" required>
                                   <small><span class="text-danger font-size-17">*</span> Note Minimum value Must Be Greater Than <?php echo e($loan->amountloaned + $loan->intrest); ?> </small>
                                        </div>
                                    <div class="mb-4 col-md-12">
            ...
            <div class="card-body">
                <div class="pb-4">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h6 class="mb-0">Total Loaned</h6>
                            <span class="text-sm text-muted">-</span>
                        </div>
                        <div class="col-6">
                            <?php $__currentLoopData = $total_loaned; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loaned): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!empty($loaned->count)): ?>
                                    <h6 class="mb-1">
                                        <b><?php echo e($settings->currency); ?><?php echo e(number_format($loaned->count, 2, '.', ',')); ?>
                                ...
                                <div class="card-footer">
                                    <div class="actions d-flex justify-content-between">
                                        <a href="<?php echo e(route('accounthistory')); ?>" class="action-item">
                                            <span class="btn-inner--icon">View Transaction history</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OT33\resources\views/user/deposits.blade.php ENDPATH**/ ?>