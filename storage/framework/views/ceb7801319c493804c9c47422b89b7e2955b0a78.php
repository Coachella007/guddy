                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span
                                                class="mb-0 h5 font-weight-bold"><?php echo e($settings->currency); ?><?php echo e(number_format($total_debt->amountloaned, 2, '.', ',')); ?></span>
                                        </div>
                                        <div class="col-auto">
                                            <div class="text-white icon bg-gradient-primary rounded-circle icon-shape">
                                                <i class="fas fa-coins"></i>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OT33\resources\views/user/dashboard.blade.php ENDPATH**/ ?>