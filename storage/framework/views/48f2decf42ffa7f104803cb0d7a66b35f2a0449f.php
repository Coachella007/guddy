...
<nav class="navBarLight navbar navbar-main navbar-expand-lg navbar-dark bg-primary navbar-border " id="navbar-main">
    <div class="container-fluid">
        ...
        <div class="ml-auto d-lg-none userNavbarContainer" id="reelsSideNav">
            <ul class=" flex-row navbar-nav align-items-center">
                <li class="userAvaterToggleIcon nav-item dropdown dropdown-animate">
                    <a class="userNavLinkToggle nav-link pr-lg-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="avatar rounded-circle">
                            <i class="userIcon fas fa-user-circle fa-2x"></i>
                        </span>
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link nav-link-icon sidenav-toggler " " data-action=" sidenav-pin" data-target="#sidenav-main"><i class="menuIcon far fa-bars"></i></a>
                </li>
...
</nav><?php /**PATH C:\XAMPP-MYSQL\htdocs\REEL\resources\views/user/topmenu.blade.php ENDPATH**/ ?>