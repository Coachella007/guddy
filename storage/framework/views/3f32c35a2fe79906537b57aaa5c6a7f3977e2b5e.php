...
<head>
    ...
    <style>
        ...
        @media  screen and (max-width: 600px) {
            /* .userMiniSideBar {
                ...
                background-color: #07458b !important;
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/css/adminSideBar.css')); ?>">
...
<body class="application application-offset">
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/v/bs4/dt-1.10.21/af-2.3.5/b-1.6.3/b-flash-1.6.3/b-html5-1.6.3/b-print-1.6.3/r-2.2.5/datatables.min.js">
    </script>
    <?php echo $__env->yieldSection(); ?>
    ...
    <!-- devloper prefered javascriopt -->
    <script type="text/javascript" src="<?php echo e(asset('public/js/adminSideBar.js')); ?>"></script>
...
</html><?php /**PATH C:\XAMPP-MYSQL\htdocs\REEL\resources\views/layouts/dash.blade.php ENDPATH**/ ?>