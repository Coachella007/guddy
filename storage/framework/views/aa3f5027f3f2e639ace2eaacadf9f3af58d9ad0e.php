                            ...
                            <form method="POST" action="<?php echo e(route ('deposits')); ?>" id="amt">
                              <?php echo csrf_field(); ?>
                                ...
                                <div class="pt-3">
                                  ...
                                  <div class="pt-3">
                                      <label for="intrest">Amount To Pay Back</label>
                                ...
                                <div class="pt-5">
                                      <a  href="<?php echo e(route('deposits')); ?>" type="submit" class="btn btn-primary" <?php echo e((($loan->amountloaned + $loan->intrest) < ($user->account_bal)) ? 'disabled' : ''); ?>  value="submit" style="width:100%;" >Submit</a>
                                </div>
                              </form>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OT3\resources\views/user/payloan.blade.php ENDPATH**/ ?>