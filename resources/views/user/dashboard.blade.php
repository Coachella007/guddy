                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="mb-0 h5 font-weight-bold">{{ $settings->currency }}{{ number_format(($total_debt->amountloaned + $total_debt->intrest) , 2, '.', ',') }}</span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="text-white icon bg-gradient-primary rounded-circle icon-shape">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h6 class="mb-1 text-muted">Total Dept</h6>
                        <span
                            class="mb-0 h5 font-weight-bold">{{ $settings->currency }}{{ number_format(0, 2, '.', ',') }}</span>
                </div>
                <div class="col-auto">
                    <div class="text-white icon bg-gradient-primary rounded-circle icon-shape">
                        <i class="fas fa-coins"></i>
