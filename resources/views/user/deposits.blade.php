                                ...
                                <div class="row">
                                    <div class="mb-4 col-md-12">
                                        ...
                                        <input class="form-control " placeholder="Enter Amount"
                                            type="number" name="amount"  value="{{ $loan->amountloaned + $loan->intrest }}"
                                            readonly
                                            min="{{ $loan->amountloaned + $loan->intrest }}" required>
                                   <small><span class="text-danger font-size-17">*</span> Note Minimum value Must Be Greater Than {{ $loan->amountloaned + $loan->intrest }} </small>
                                        </div>
                                    <div class="mb-4 col-md-12">
            ...
            <div class="card-body">
                <div class="pb-4">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            @foreach ($total_loaned as $loaned)
                                @if (!empty($loaned->count))
                                    <h6 class="mb-1">
                                        <b>{{ $settings->currency }}{{ number_format($loaned->count, 2, '.', ',') }}
                                        </b>
                                    </h6>
                                @else
                                    <h6 class="mb-1">
