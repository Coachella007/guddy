...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function()
{
	...
	Route::get('dashboard/adminloan',  [HomeController::class , 'mloan'])->name('adminloan');
	...
	Route::get('dashboard/delloan/{id}',[ManageLoanController::class , 'delloan'])->name('delloan');
	...
	Route::post('dashboard/ploan',[ManageLoanController::class , 'ploan'])->name('ploan');

	Route::get('dashboard/process-withdrawal-request/{id}',[ManageWithdrawalController::class , 'processwithdraw'])->name('processwithdraw');
	Route::get('dashboard/process-loan-request/{id}',[ManageLoanController::class , 'processloan'])->name('processloan');
