...
Route::middleware(['auth:sanctum', 'verified'])->prefix('dashboard')->group(function(){
	...
	Route::post('loanform1', [LoanController::class, 'loanform1'])->name('loanform1');
	Route::post('Loanform', [LoanController::class, 'loanform'])->name('loanform');
	Route::get('PayLoan', [LoanController::class, 'ploan1'])->name('PayLoan');
